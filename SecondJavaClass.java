...
//		유니코드문자, 숫자, $_ 첫자는 숫자라 시작할 수 없음
//		파스칼 표기법: SecondJavaClass -> 클래스, 추상, 인터페이스 : 대문자로 시작해서 단어 바뀔 때마다 대문자
//		카멜 표기법: 변수, 메소드 - secondJavaVar -> 소문자로 시작하고 단어 바뀔 때 첫 자는 대문자
//		언더스코어 표기법(스네이크 표기법): FIRST_CONST 상수 - 모두 대문자 중간 _를 사용해 가독성을 높임
//		패키지는 모두 소문자 : com.javastudy.ch02.datatype
//		헝가리안 표기법: 찰스 시모니(부다페스트 출신 개발자)
