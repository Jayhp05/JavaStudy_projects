...
public class HashSetClass01 {	
	public static void main(String[] args) {
		...
		String s1 = new String("자바 프로그래밍");
		String s2 = new String("자바 프로그래밍");
		System.out.println(s1.hashCode() + ", " + s2.hashCode());
		
//		Member 제네릭타입으로 Set 데이터 출력
		System.out.println("### Member 제네릭타입으로 Set 데이터 출력 ###");
		HashSet<Member> mSet = new HashSet<>();
		Member m1 = new Member("midas", "홍길동", 25);
		Member m2 = new Member("midas", "홍길동", 25);
		mSet.add(m1);
		mSet.add(m2);
		
		System.out.println(m1.hashCode() + ", " + m2.hashCode());
		
//		mSet.add(new Member("midas", "홍길동", 25));
		
		System.out.println(mSet);
		System.out.println(m1.equals(m2));
		System.out.println();
		
//		순서를 유지 하지 않으며, 중복을 허용하지 않음
		 ...
		 * */
		while(iter.hasNext()) { // haseNext()는 다음 요소가 있는지를 true나 false로 알려주는 역할.
